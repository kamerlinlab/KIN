...
PI_PI_RES_ATOMS = {"TYR": "CG CE1 CE2", "PHE": "CG CE1 CE2",
                   "TRP": "CG CD2 NE1", "HIE": "CG CD2 CE1",
...
def check_for_pi_pi(res_numbers:tuple[int, int], universe, detailed_information:bool=False) -> Optional[str]:
    ...
    res1_sele_str = "name " + PI_PI_RES_ATOMS[res1_name] + " and resid " + str(res1_numb)
    res2_sele_str = "name " + PI_PI_RES_ATOMS[res2_name] + " and resid " + str(res2_numb)
