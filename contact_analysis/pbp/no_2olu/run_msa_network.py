...
input_fiels = "/storage/home/hhive1/dyehorova3/data/tools-project/contact_analysis/pbp/no_2olu/msa_index_contacts/"
...
conservation_tem_msa, colors_int_type, properties, _, _, _ = common_network(
    input_fiels, "1nrf", contact_index, no_vdw=True, only_sc=False
)
print(properties)
