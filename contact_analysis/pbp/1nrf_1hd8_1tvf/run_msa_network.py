...
input_fiels = "/storage/home/hhive1/dyehorova3/data/tools-project/contact_analysis/pbp/1nrf_1hd8_1tvf/msa_index_contacts/"
projection_output = "1nrf_network.pml"
contact_index = "pdb"
properties_filename = "properties_1nrf.csv"
conservation_tem_msa, colors_int_type, properties, _, _, _ = common_network(
    input_fiels, "1nrf", contact_index, no_vdw=False, only_sc=False
)
print(properties)
if contact_index == "pdb":
    ...
    output_filename = "network_1nrf_pdb.csv"
    colors_file = "colors_1nrf_pdb.csv"
else:
    output_filename = "network_1nrf_msa.csv"
