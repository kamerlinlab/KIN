...
input_fiels = (
    "/Users/dariiayehorova/lk_research/tools-project/contact_analysis/static_contacts_processing/msa_index_contacts/"
)
projection_output = "shared_network/1M40_TEM-1_network.pml"
contact_index="msa"
...
if contact_index == "pdb":
    ...
    output_filename = 'shared_network/network_tem1_pdb.csv'
else:
