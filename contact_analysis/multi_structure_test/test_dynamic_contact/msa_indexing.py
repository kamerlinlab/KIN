...
# PDB_OUTPUT = "1M40_TEM-1_test_crystal.txt"
PDB_OUTPUT = "1M40_TEM-1_test_md.txt"
# MSA_OUTPUT = "1M40_TEM-1_msa_crystal.csv"
MSA_OUTPUT = "1M40_TEM-1_msa_md.csv"
...
pdb_df = parse_contact_output(PDB_OUTPUT, contact_type="md")
msa_df = indexing_pdb_to_msa(seq, pdb_df)
print(msa_df.shape)
